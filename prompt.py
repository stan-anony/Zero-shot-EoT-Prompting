...
prompt_307 = "Let's first understand the problem, extract relevant variables and their corresponding numerals, " \
             ...
             "(pay attention to correct numerical calculation and commonsense), " \
             "solve the problem step by step, and show the answer."     
prompt_401 = "I'd like you to follow the instructions step-by-step to solve the problem step by step, and show the answer. " \
            "1. Crossover the following prompts and generate a new prompt: " \
            "Prompt 1: Let's first understand the problem and carefully extract all relevant variables and their corresponding numerals. " \
            "Then, Let's calculate intermediate variables (pay attention to correct numerical calculation and common sense) and solve the problem step by step carefully. " \
...
prompt_402 = "I'd like you to first crossover and mutate the following two prompts to generate a new prompt:" \
            "Prompt 1: Let's first understand the problem and carefully extract all relevant variables and their corresponding numerals. " \
            "Then, Let's calculate intermediate variables (pay attention to correct numerical calculation and commonsense) and solve the problem step by step carefully. " \
            "Prompt 2: Let's first understand the problem and solve the problem step by step. " \
            "Finally, select the best-generated prompt to think, rewrite, solve the problem step by step, and show the answer."
prompt_403 = "I'd like you to first crossover and mutate the following two prompts to generate prompts:" \
            "Prompt 1: Let's first understand the problem and prepare relevant information." \
            "Then, let's answer the question step by step (pay attention to commonsense and logical coherence). " \
            "Prompt 2: Let's first understand the problem and devise a plan to solve the problem step by step, and show the answer. " \
            "Finally, select the best generated prompt to rewrite, solve the problem step by step, and show the answer."
prompt_404 = "I'd like you to mutate the following two prompts to generate a better prompts:" \
            "Prompt 1: Let's first understand the problem and prepare relevant information." \
            "Then, let's answer the question step by step (pay attention to commonsense and logical coherence). " \
            "Prompt 2: Let's first understand the problem and devise a plan to solve the problem step by step, and show the answer. " \
            "Finally, select the best generated prompt to rewrite, solve the problem step by step, and show the answer."
prompt_405 = "I'd like you to crossover and mutate the following two prompts to generate a better prompts:" \
            "Prompt 1: Let's think step by step." \
            "Prompt 2: Let's first understand the problem and devise a plan to solve the problem step by step, and show the answer. " \
            "Finally, select the best-generated prompt to think, rewrite, solve the problem step by step, and show the answer."
prompt_406 ="Below are the two Prompts:" \
            "Prompt 1: Let's think step by step." \
            "Prompt 2: Let's first understand the problem and carefully extract all relevant variables and their corresponding numerals. " \
            "Then, Let's calculate intermediate variables (pay attention to correct numerical calculation and commonsense) and solve the problem step by step carefully. " \
            "I'd like you to follow the instruction step-by-step to generate a new prompt:" \
            "1. Crossover the two prompts and generate a new prompt " \
            "2. Mutate the prompt generated in Step 1 and generate a new prompt " \
            "3. Select the best-generated prompt directly to think, rewrite, solve the problem step by step, and show the answer."
prompt_407 ="Below are the two Prompts:" \
            "Prompt 1: Let's think step by step." \
            "Prompt 2: Let's first understand the problem." \
            "Then, let's reason problem step by step. Every step answer the subquestion, " \
            "\"does the person flip and what is the coin's current state?\". According to the coin's last state, " \
            "give the final answer (pay attention to every flip and the coin's turning state)." \
            "I'd like you to follow the instruction step-by-step to generate new prompts:" \
            "1. Crossover the two prompts and generate a new prompt " \
            "2. Mutate the prompt generated in Step 1 and generate a new prompt " \
            "3. Select the best-generated prompt directly to think, rewrite, solve the problem step by step, and show the answer."
prompt_408 ="Below are the two Prompts:" \
            "Prompt 1: Let's think step by step." \
            "Prompt 2: Let's first understand the problem." \
            "Then, let's reason problem step by step. Every step answer the subquestion, " \
            "\"does the person flip and what is the coin's current state?\". According to the coin's last state, " \
            ...
            "1. Crossover the two prompts and generate a new prompt " \
            "2. Mutate the prompt generated in Step 1 and generate a new prompt " \
            "3. Select the best-generated prompt directly to think, solve the problem step by step, and show the answer."
prompt_501 = "I'd like you to follow the instructions step-by-step to solve the problem step by step, and show the answer. " \
            "1. Crossover the following prompts and generate a new prompt: " \
            "Prompt 1: Let's first understand the problem and carefully extract all relevant variables and their corresponding numerals. " \
            "Then, Let's calculate intermediate variables (pay attention to correct numerical calculation and common sense) and solve the problem step by step carefully. " \
            "Prompt 2: Let's first understand the problem and solve the problem step by step. " \
            "2. Mutate the crossover prompt in Step 1 to generate a new prompt." \
            "3. Keep the prompt generated in Step 2, repeat Step 1, 2, until you have 10 generated prompts." \
            "4. Select a final prompt in Step 3 to think, rewrite, solve the problem step by step, and show the answer."
prompt_502 ="I'd like you first to identify the different parts between the Prompt 1 and Prompt 2:" \
            "Prompt 1: Let's first understand the problem and carefully extract all relevant variables and their corresponding numerals. " \
            "Then, Let's calculate intermediate variables (pay attention to correct numerical calculation and common sense) and solve the problem step by step carefully. " \
            "Prompt 2: Let's first understand the problem and solve the problem step by step. " \
            "1. Then, randomly mutate the different parts and combine the different parts with Prompt 2 to generate new prompts."\
            "2. Crossover the generated prompts in Step 2 with Prompt 2 to generate a final prompt." \
            "3. Apply the final prompt to think, rewrite, solve the problem step by step, and show the answer."
def get_prompt():
